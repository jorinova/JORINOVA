          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-0 top-0 h-full px-3 py-2 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 transition-colors focus-visible:text-blue-500 outline-none"
              ...
              >
                {showPassword ? (
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.644C3.413 7.058 7.244 4 12 4c4.756 0 8.773 3.162 10.065 7.498a1.01 1.01 0 010 .644C20.587 16.942 16.756 20 12 20c-4.756 0-8.773-3.162-10.065-7.498z" />
