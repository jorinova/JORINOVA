          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-0 top-0 h-full px-3 flex items-center text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 focus:outline-none transition-colors"
